...
function toggleNotificationDropdown() {
    ...
    function loadNotifications() {
        fetch('../includes/notifications.php?ajax=1&action=get_notifications&limit=10')
            .then(res => res.json())
            .then(data => {
                if (data.success) {
    ...
    function renderNotifications(notifications) {
        ...
        notifications.forEach(noti => {
            ...
            item.onclick = function(e) {
                e.stopPropagation();
                fetch(`../includes/notifications.php?ajax=1&action=mark_as_read&notification_id=${noti.Noti_id}`)
                    .then(() => {
                        if (noti.Re_id) {
    ...
    function markAllAsRead() {
        fetch('../includes/notifications.php?ajax=1&action=mark_all_as_read')
            .then(res => res.json())
            .then(data => {
                if (data.success) {
                    loadNotifications();
