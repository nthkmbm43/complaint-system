...
<body>
        ...
        <div class="container">
            ...
            <form method="POST" enctype="multipart/form-data" class="complaint-form" id="complaintForm">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <div style="display: block; margin-bottom: 8px; color: #333; font-weight: 500;">📅 วันที่ร้องเรียน</div>
    ...
    <script>
        ...
        // (ลบ validateForm() แบบเก่าออกแล้ว เนื่องจากถูกนำไปรวมไว้ที่ submit event listener ด้วย SweetAlert2)
        ...
        // ฟังก์ชันตรวจสอบฟอร์มก่อนส่ง (อัพเดตเป็น SweetAlert2)
        document.getElementById('complaintForm').addEventListener('submit', function(e) {
            e.preventDefault(); // หยุดการส่งฟอร์มแบบปกติไว้ก่อน
            ...
            if (isAnonymous) {
                // ใช้ SweetAlert2 แทน confirm() แบบดั้งเดิม
                Swal.fire({
                    title: '🔒 ยืนยันการร้องเรียนแบบไม่ระบุตัวตน',
                    html: `
                        <div style="text-align: left; font-size: 1rem; color: #555; line-height: 1.6;">
                            <p><strong>•</strong> เจ้าหน้าที่จะไม่สามารถเห็นข้อมูลส่วนตัวของคุณได้</p>
                            <p><strong>•</strong> คุณยังสามารถติดตามสถานะได้ตามปกติ</p>
                            <p style="color: #dc3545; margin-top: 10px;">
                                ⚠️ <strong>คำเตือน:</strong> หากมีการรายงานว่าไม่เหมาะสม บัญชีอาจถูกระงับ
                            </p>
                        </div>
                    `,
                    icon: 'warning',
                    ...
                    cancelButtonColor: '#6c757d',
                    confirmButtonText: '🚀 ยืนยันและส่งข้อร้องเรียน',
                    ...
                    if (result.isConfirmed) {
                        ...
                        // แนบค่า submit_complaint เข้าไปด้วยเพราะการใช้ JS .submit() จะไม่ส่งค่าจากปุ่มมา
                        const submitInput = document.createElement('input');
                        submitInput.type = 'hidden';
                        submitInput.name = 'submit_complaint';
                        submitInput.value = '1';
                ...
                // แนบค่า submit_complaint เข้าไปด้วย
                const submitInput = document.createElement('input');
                submitInput.type = 'hidden';
                submitInput.name = 'submit_complaint';
                submitInput.value = '1';
