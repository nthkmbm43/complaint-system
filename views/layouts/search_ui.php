...
<script>
    ...
    class AdvancedSearchSystem {
        ...
        async loadFacets() {
            try {
                const response = await fetch('../../core/advanced_search.php?ajax=1&action=stats');
        ...
        async handleQuickSearch(query, delay = 300) {
            ...
            this.quickSearchTimeout = setTimeout(async () => {
                try {
                    const response = await fetch('../../core/advanced_search.php', {
                        method: 'POST',
                        headers: {
        ...
        async exportSearchResults(format) {
            ...
            form.method = 'POST';
            form.action = '../../core/advanced_search.php';
