    ...
    try {
        ...
        switch ($action) {
            case 'submit_work':
                ...
                $msg = 'ระบบได้บันทึกผลการดำเนินงานเบื้องต้นเรียบร้อยแล้ว' . $uploadMsg;
                ...
                if (!empty($complaint['Stu_email'])) {
                    ...
                    $body = "<div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;'>" .
                        ...
                        "</div>" .
                        "<p>$greeting,</p>" .
                        "<p>ทางเราขอแจ้งความคืบหน้าว่า ขณะนี้ข้อร้องเรียนของคุณ <strong>ได้รับการดำเนินการแก้ไขปัญหาในเบื้องต้นเรียบร้อยแล้ว</strong> และอยู่ในขั้นตอน <span style='color:#eab308; font-weight:bold;'>รอการประเมินความพึงพอใจ</span> จากผู้ร้องเรียน</p>" .
                        "<div style='background:#f8fafc; padding:20px; border-radius:10px; border-left:4px solid #3b82f6; margin: 20px 0;'>" .
                        "<h3 style='color:#2563eb; margin:0 0 10px 0;'>📄 ข้อมูลการแก้ไขปัญหา</h3>" .
                        "<p style='margin:0 0 8px 0; color:#374151;'>เรื่อง: <strong>" . htmlspecialchars($complaint['Re_title']) . "</strong></p>" .
                        "<p style='margin:0 0 15px 0; color:#374151;'>รหัสอ้างอิง: <strong>#$complaintId</strong></p>" .
                        "<p style='margin:0 0 8px 0; color:#374151;'><strong>รายละเอียดการดำเนินการ:</strong><br>" . nl2br(htmlspecialchars($solutionDetail)) . "</p>" .
                        "<br><p style='margin:0; font-size: 14px;'>" . $staffInfo . "</p>" .
                        $attachmentInfo .
                        "</div>" .
                        "<p>เพื่อให้การดำเนินการสมบูรณ์แบบ กรุณาเข้าสู่ระบบเพื่อทำการประเมินความพึงพอใจในการให้บริการของเจ้าหน้าที่ในครั้งนี้</p>" .
                        "<div style='text-align: center; margin: 30px 0;'>" .
                        "<a href='$link' style='background-color: #0ea5e9; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;'>เข้าสู่ระบบเพื่อประเมินผล</a>" .
                        "</div>" .
                    ...
                    $mailRes = $sendMailFunc($complaint['Stu_email'], $complaint['Stu_name'] ?? 'นักศึกษา', "ℹ️ แจ้งความคืบหน้า: ข้อร้องเรียน #$complaintId ดำเนินการแก้ไขแล้ว", $body);
            ...
            case 'mark_complete':
                ...
                $msg = 'ระบบได้บันทึกการดำเนินการเสร็จสิ้นสมบูรณ์แล้ว';
                ...
                if (!empty($complaint['Stu_email'])) {
                    ...
                    $body = "<div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;'>" .
                        ...
                        "</div>" .
                        "<p>$greeting,</p>" .
                        "<p>ทางเราขอแจ้งให้ทราบว่า ข้อร้องเรียนของคุณได้รับการดำเนินการ <span style='color:#10b981; font-weight:bold;'>เสร็จสิ้นสมบูรณ์แล้ว</span> และคดี/ข้อร้องเรียนนี้ได้ถูกปิดลงอย่างเป็นทางการ</p>" .
                        "<div style='background:#ecfdf5; padding:20px; border-radius:10px; border-left:4px solid #10b981; margin: 20px 0;'>" .
                        "<h3 style='color:#059669; margin:0 0 10px 0;'>✅ สรุปการดำเนินงาน (เสร็จสิ้น)</h3>" .
                        "<p style='margin:0 0 8px 0; color:#374151;'>เรื่อง: <strong>" . htmlspecialchars($complaint['Re_title']) . "</strong></p>" .
                        "<p style='margin:0 0 15px 0; color:#374151;'>รหัสอ้างอิง: <strong>#$complaintId</strong></p>" .
                        "<p style='margin:0 0 8px 0; color:#374151;'><strong>รายละเอียดการดำเนินงานรอบสุดท้าย:</strong><br>" . nl2br(htmlspecialchars($solutionDetail ?: 'ดำเนินการเรียบร้อยแล้ว')) . "</p>" .
                        "<br><p style='margin:0; font-size: 14px;'>" . $staffInfo . "</p>" .
                        "</div>" .
                        "<p>ขอบคุณที่ใช้บริการระบบข้อร้องเรียน หากมีเรื่องอื่นหรือพบปัญหาเพิ่มเติม สามารถแจ้งให้ทางเราทราบได้ตลอดเวลา</p>" .
                        "<div style='text-align: center; margin: 30px 0;'>" .
                        "<a href='$link' style='background-color: #10b981; color: white; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;'>เข้าสู่ระบบตรวจสอบประวัติ</a>" .
                        "</div>" .
                        "<hr style='border:none; border-top:1px solid #e5e7eb; margin:30px 0;'>" .
                        "<p style='color:#6b7280; font-size: 12px; text-align: center;'>อีเมลฉบับนี้ถูกส่งจากระบบอัตโนมัติ กรุณาอย่าตอบกลับอีเมลนี้<br>หากมีข้อสงสัยเพิ่มเติม สามารถติดต่อสอบถามได้ที่สำนักงานคณะ</p>" .
                        "</div>";

                    $mailRes = $sendMailFunc($complaint['Stu_email'], $complaint['Stu_name'] ?? 'นักศึกษา', "✅ สถานะล่าสุด: ข้อร้องเรียน #$complaintId ปิดงานเสร็จสิ้นแล้ว", $body);
...
<head>
    ...
    <style>
        ...
        .modal-actions .btn-submit {
            background: linear-gradient(135deg, #10b981, #059669) !important; /* สีเขียว */
            color: white !important;
            border: none;
            padding: 12px 24px;
            border-radius: 10px;
